...
function Validation(username, password) {
    ...
    var Valprom = new Promise((resolve, reject) => {
        let ValQuery = `SELECT * from "DEMO".autorization where username=$1 and password=$2`
...
function InsertAuthaerization(req, res) {
    ...
    let InseartQuarry = `INSERT INTO "DEMO".autorization(username,password) VALUES ('${user.username}','${user.password}')`;
